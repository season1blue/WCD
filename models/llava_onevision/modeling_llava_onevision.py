...
from .modeling_qwen import Qwen2Model
...
class LlavaOnevisionModel(LlavaOnevisionPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.language_model = Qwen2Model._from_config(config.text_config)
...
class LlavaOnevisionForConditionalGeneration(MyGenerationMixin, LlavaOnevisionPreTrainedModel):
