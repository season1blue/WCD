...
class VipLlavaModel(VipLlavaPreTrainedModel):
    ...
    def __init__(self, config: VipLlavaConfig):
        ...
        self.language_model = AutoModel.from_config(config.text_config)  # 原本的
        
        from .modeling_llama import LlamaModel
        self.language_model = LlamaModel._from_config(config.text_config)
        self.post_init()
...
class VipLlavaForConditionalGeneration(MyGenerationMixin, VipLlavaPreTrainedModel):
