...
class Qwen2VLModel(Qwen2VLPreTrainedModel):
    ...
    def forward(
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            ...
            if output_attentions and generation_config.pos is not None and layer_idx == generation_config.target_layer_idx and generation_config.attn_mask:
                masked_hidden_states = apply_soft_mask_to_image_embeds(hidden_states.clone(), max_jsd_diff, generation_config, mask_scale=1e-9)
...
class Qwen2VLForConditionalGeneration(MyGenerationMixin, Qwen2VLPreTrainedModel):
